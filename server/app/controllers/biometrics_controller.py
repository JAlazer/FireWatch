...
def get_biometrics(user_id: str, repo: MockBiometricsRepository = Depends(get_biometrics_repo)) -> BiometricsResponse:
...
def save_biometrics(
    ...
    repo: MockBiometricsRepository = Depends(get_biometrics_repo),
) -> BiometricsResponse:
